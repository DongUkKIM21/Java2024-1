 ...
 * 					1-2-1. 두 개의 매개변수를 전달받아 합계 계산
 * 					1-2-2. 합계를 돌려준다. - 정수값
 * 				1-3. 짝수 합계 계산하는 메소드 선언.
 * 					1-3-1. 두 개의 매개변수를 전달받아 합계 계산
 * 					1-3-2. 합계를 돌려준다. - 정수값
 * 				1-4. 홀수 합계 계산하는 메소드 선언.
 * 					1-4-1. 두 개의 매개변수를 전달받아 합계 계산
 * 					1-4-2. 합계를 돌려준다. - 정수값
 * 
 * 			2. 메인 메소드가 있는 클래스 선언.
 * 				2-1. 두 개의 정수를 입력 받는다.
...
class Sum{
	...
	public int allSum(int num1, int num2){
		...
		return sum; //메소드를 호출 한 곳으로 값을 돌려 줌.
...
public class SumTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(num1 + "부터 " + num2 +"까지 의 합 : " + s.allSum(num1, num2));

		// 입력받은 값은 s  객체를 통해서 Sum 클래스의 oddSum()메소드로 전달.
		System.out.println(num1 + "부터 " + num2 +"까지 의 합 : " + s.oddSum(num1, num2));

		// 입력받은 값은 s  객체를 통해서 Sum 클래스의 evenSum()메소드로 전달.
		System.out.println(num1 + "부터 " + num2 +"까지 의 합 : " + s.evenSum(num1, num2));
