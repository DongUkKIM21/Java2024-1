...
// 박스의 부피 계산하는 클래스
class Box {
	int width;	//멤버변수 - 객체 변수
	int height; //클래스 저역에서 사용 가능
	int depth;
